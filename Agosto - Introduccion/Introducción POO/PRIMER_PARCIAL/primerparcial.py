...
print(materia2.nueva_modalidad())
print(materia2.nueva_nota())
print(materia2.nuevo_tema())
print(materia2.nueva_ubi())
...
print(materia3.nueva_modalidad())
print(materia3.nueva_nota())
print(materia3.nuevo_tema())
print(materia3.nueva_ubi())
...
print(materia4.nueva_modalidad())
print(materia4.nueva_nota())
print(materia4.nuevo_tema())
print(materia4.nueva_ubi())
...
print(materia5.nueva_modalidad())
print(materia5.nueva_nota())
print(materia5.nuevo_tema())
print(materia5.nueva_ubi())
...
print(materia6.nueva_modalidad())
print(materia6.nueva_nota())
print(materia6.nuevo_tema())
print(materia6.nueva_ubi())
...
print(materia1.sin_modulo())
print(materia1.sin_nota())
print(materia1.sin_tema())
print(materia1.sin_ubi())
...
print(materia2.sin_modulo())
print(materia2.sin_nota())
print(materia2.sin_tema())
print(materia2.sin_ubi())
...
print(materia3.sin_modulo())
print(materia3.sin_nota())
print(materia3.sin_tema())
print(materia3.sin_ubi())
...
print(materia4.sin_modulo())
print(materia4.sin_nota())
print(materia4.sin_tema())
print(materia4.sin_ubi())
...
print(materia5.sin_modulo())
print(materia5.sin_nota())
print(materia5.sin_tema())
print(materia5.sin_ubi())
...
print(materia6.sin_modulo())
print(materia6.sin_nota())
print(materia6.sin_tema())
print(materia6.sin_ubi())